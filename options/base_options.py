...
class parser(object):
    def __init__(self):
        ...
        self.image_folder = "./U2-net/inputdata/train/"  # image folder path
        self.df_path = "./U2-net/inputdata/train.csv"  # label csv path
        ...
        if self.continue_train:
            self.unet_checkpoint = "prev_checkpoints/u2net.pth"
